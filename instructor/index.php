    ...
    <div class="row mt-4">
        <div class="col-md-4">
            <div class="card">
                <div class="card-header bg-success text-white">
                    <h6 class="mb-0">Upload Course</h6>
                </div>
                <div class="card-body">
                    <p>Create and upload new course content with lessons, videos, and materials.</p>
                    <a href="add-course.php" class="btn btn-success w-100">Upload Course</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="card">
                <div class="card-header bg-primary text-white">
                    <h6 class="mb-0">Add Lessons</h6>
                </div>
                <div class="card-body">
                    <p>Add new lessons and learning materials to your existing courses.</p>
                    <a href="add_lessons.php" class="btn btn-primary w-100">Add Lessons</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-body">
                    <p>Create assessments, quizzes, and assignments for your students.</p>
                    <a href="create_quiz.php" class="btn btn-warning w-100">Create Quiz</a>
                </div>
            </div>
        </div>
    </div>
